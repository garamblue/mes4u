    ...
    <el-col>
      <div class="components-container">
        ...
        <div class="mixin-components-container">
                  ...
                  <el-form :inline="true" :model="historyQuery">
                    ...
                    <el-row id="assy">
                      ...
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.itemNumber" class="filter-item search-condition-1" placeholder="Item" style="font-size:1rem;" clearable @keyup.enter="handleFilter">
                          <template #prepend>
                            <el-button icon="Search" @click="handleItemModal('assy')" />
                          </template>
                        </el-input>
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.serialNumber" class="filter-item search-condition-1" placeholder="Serial" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.configIndicator" class="filter-item search-condition-1" placeholder="Barcode" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <Searchselect v-model="historyQuery.productFamily" name="family" placeholder="Family" class="search-condition-1" />
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.resultValue" class="filter-item search-condition-1" placeholder="Result Value" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                    </el-row>
                    <el-row id="part">
                      <el-col :sm="24" :md="24" :lg="2">
                      ...
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.partItemNumber" class="filter-item search-condition-2" placeholder="Item" style="font-size:1rem;" clearable @keyup.enter="handleFilter">
                          <template #prepend>
                            <el-button icon="Search" @click="handleItemModal('part')" />
                          </template>
                        </el-input>
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.partSerialNumber" class="filter-item search-condition-2" placeholder="Serial" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                    </el-row>
                    <el-row id="operation">
                      <el-col :sm="24" :md="24" :lg="2">
                      ...
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.userName" class="filter-item search-condition-3" placeholder="Operator" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input v-model="historyQuery.operationDesc" class="filter-item search-condition-3" placeholder="Part Barcode" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                      <!-- Button -->
          ...
          <LOVItem :dialog-visible="itemDialogVisible" :input-item="inputItem" @apply-item="selectItem" />
        </div>
      </div>
    </el-col>
  </el-row>
...
.search-condition-1 :deep(input),
.search-condition-1 :deep(.el-input__wrapper),
.search-condition-1 :deep(.el-select__wrapper) {
  background : #e1faf0;
}
/* search condition color 2 */
.search-condition-2 :deep(input),
.search-condition-2 :deep(.el-input__wrapper),
.search-condition-2 :deep(.el-select__wrapper) {
  background : #f8fae1;
}
/* search condition color 3 */
.search-condition-3 :deep(input),
.search-condition-3 :deep(.el-input__wrapper),
.search-condition-3 :deep(.el-select__wrapper) {
  background : #fdf6f7;
}
</style>
