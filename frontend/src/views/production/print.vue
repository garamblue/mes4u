      ...
      <div class="components-container">
        ...
        <div class="mixin-components-container">
                    ...
                    <el-col :lg="20">
                      <el-form label-position="left" label-width="100px">
                        <el-form-item id="labeltype" label="Label Type">
                          <Searchselect v-model="labelType" name="printingjoblabel" :itemid="selectedItemid" @label-list="getLabelContent" @change="showLabelParameters" />
                        </el-form-item>
                      </el-form>
                    </el-col>
                    <el-col :lg="4">
                      <el-button id="serialguide" type="primary" round size="small" style="vertical-align: text-bottom;" @click="guide" @click.prevent.stop="guide">Guide</el-button>
                    </el-col>
                  </el-row>
                </div>
              </template>
              <el-row id="labelparams" :gutter="10">
                <el-form ref="printForm" :model="printForm" class="form-container">
                  ...
                  <el-col :span="customspan" :style="printbutton">
                    <Btn id="labelprintbtn" name="print" icon="Printer" @click="printLabel" />
                  </el-col>
                </el-form>
              </el-row>
            </el-card>
          ...
          <el-row v-if="serialflag">
            <el-card class="box-card" style="margin-bottom:10px;">
              <template #header>
                <div id="serialnumberguide" class="clearfix">
    ...
    showLabelParameters(value) {
      if (this.labelList.length > 0) {
        ...
        this.$nextTick(() => {
          ...
          // the columns (el-col) are the direct children of the form element
          const children = Array.from(this.$refs.printForm.$el.children).map(e => e.scrollHeight)
          const maxHeight = Math.max(...children)
          const minHeight = Math.min(...children)
