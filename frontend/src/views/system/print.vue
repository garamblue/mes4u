                    ...
                    <div class="clearfix">
                      ...
                      <el-row>
                        <el-col :xs="24" :sm="24" :md="24">
                          ...
                          />
                          <el-input id="searchname" v-model="listQuery.file" placeholder="File" style="width: 200px;" class="filter-item" @keyup.enter="handleFilter" />
      ...
      <el-dialog v-model="dialogFormVisible" :title="title">
        <el-form ref="programForm" :rules="programRules" :model="programObject" label-position="left" label-width="150px" style="margin-left:50px;">
          ...
          <el-form-item label="Name" prop="name">
            <el-input v-model="programObject.name" @keyup.enter="confirmData()" />
          </el-form-item>
          <el-form-item label="File" prop="file">
            <el-input v-model="programObject.file" @keyup.enter="confirmData()" />
          </el-form-item>
          <el-form-item label="Description" prop="description">
            <el-input v-model="programObject.description" @keyup.enter="confirmData()" />
          </el-form-item>
          <el-form-item label="Used Operation" prop="usedoperation">
            <el-input v-model="programObject.usedoperation" @keyup.enter="confirmData()" />
          </el-form-item>
          ...
          <el-form-item label="QR Code" prop="qrcode">
            <el-input v-model="programObject.qrcode" @keyup.enter="confirmData()" />
          </el-form-item>
