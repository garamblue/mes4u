            ...
            <el-card id="barcode" class="box-card" style="margin-bottom:10px;">
              ...
              <el-row>
                <el-col :sm="24" :md="24" :lg="12" style="padding-right:20px;">
                  <el-input ref="barcode" v-model.trim="inputBarcode" size="large" class="input-required-yellow" placeholder="Please enter an Assy Barcode" style="font-size:1rem;" clearable autofocus @keyup.enter="barcodeScan" />
                </el-col>
              </el-row>
            </el-card>
            <!-- Scan Result -->
