              ...
              <el-row style="margin-top: 10px;">
                <el-col :span="24">
                  <el-form-item id="packingnumber" label="Packing Number">
                    <el-col :span="10">
                      <el-input v-model="packing.packingNumber" placeholder="Please enter packing number" @keyup.enter="onFind" />
                    </el-col>
                    <el-col :span="10">
                      <Btn id="searchbtn" name="search" @click="onFind" />
                      <Btn id="cancelbtn" name="cancel" @click="cancelForm" />
                      <Btn id="packbtn" name="pack" icon="Box" @click="packForm" />
                      <Btn id="printbtn" name="print" icon="Printer" @click="printing" />
                    </el-col>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <el-form-item id="barcode" label="Scan Content Barcode">
                    <el-col :span="14">
                      <el-input ref="barcode" v-model="barcode" placeholder="Please enter the barcode" @keyup.enter="insertForm" />
                    </el-col>
