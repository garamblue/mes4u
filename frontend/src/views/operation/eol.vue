            ...
            <el-card id="barcode" class="box-card" style="margin-bottom:10px;">
              ...
              <el-row>
                <el-col :sm="24" :md="24" :lg="12" style="padding-right:20px;">
                  <el-input ref="barcode" v-model.trim="inputInfo.barcode" size="large" class="input-required-yellow" placeholder="Please enter an Assy Barcode" style="font-size:1rem;" clearable autofocus @keyup.enter="barcodeScan" />
                </el-col>
...
<style scoped>
/* input required */
.input-required-yellow :deep(input),
.input-required-yellow :deep(.el-input__wrapper),
.input-required-yellow :deep(.el-select__wrapper) {
  background : #fcfc7e;
}
</style>
