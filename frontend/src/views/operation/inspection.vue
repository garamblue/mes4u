    ...
    <el-row>
            ...
            >
              ...
              >
                <template #default="{row}">
                  <div>
                    <!--{{row}}-->
                    <el-input :ref="'result' + row.index" v-model="row.result" :readonly="row.isReadonly" class="toupper" @keyup.enter="createInspection(row.index)" />
                  </div>
                </template>
              </el-table-column>
            </el-table>
      ...
      <el-col :sm="24" :md="24" :lg="24">
        <el-card id="history" class="box-card">
          <template #header>
            <div class="clearfix">
              <strong><span><el-icon><Reading /></el-icon> [Today] Inspection Histories  </span></strong>
            </div>
          </template>
          <historytable
            :data="historyData"
