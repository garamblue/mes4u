          ...
          <div id="barcode" style="margin-bottom:15px;">
            <el-row>
              <el-col :xs="24" :sm="24" :md="6" class="text-center">
                <Btn id="reset" name="reset" icon="Setting" @click="resetInfo" />
              </el-col>
              <el-col :xs="24" :sm="24" :md="18">
                <el-input ref="config" v-model="inputConfig" size="large" class="toupper" placeholder="Please input Config Label" clearable autofocus @keyup.enter="checkAssyInfo" />
              </el-col>
            </el-row>
          </div>
    ...
    <el-dialog v-model="dialogFormVisible" :title="textMap[dialogStatus]">
      <el-form ref="dataForm" :rules="repairrules" :model="repairSet" label-position="right" label-width="180px" style="margin-left:20px;margin-right:20px;">
        ...
        <el-form-item label="Defect Code" prop="defectcode">
          ...
          <DefectCodeList placeholder="Defect Code" :defaultvalue="repairSet.defectcode" required @set-defect-code="setDefectCode" />
        </el-form-item>
        ...
        <el-form-item label="Repair Code" prop="repaircode">
          ...
          <RepairCodeList placeholder="Repair Code" :defaultvalue="repairSet.repaircode" required @set-repair-code="setRepairCode" />
        </el-form-item>
    ...
    <el-row>
      <el-col :sm="24" :md="24" :lg="24">
        <el-card id="history" class="box-card">
          <template #header>
            <div class="clearfix">
              <strong><span><el-icon><Reading /></el-icon>Repair History</span></strong>
            </div>
          </template>
          <el-table
            ref="repairData"
...
<style scoped>
 ...
 .toupper :deep(input:read-only),
 .toupper :deep(.el-input__wrapper:has(input:read-only)) {
    background-color: #f0f0f0 !important;
  }
 .toupper :deep(input:focus),
 .toupper :deep(.el-input__wrapper:has(input:focus)) {
