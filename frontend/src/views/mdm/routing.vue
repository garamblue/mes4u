  ...
  <el-row>
    <el-col>
      <div class="components-container">
                        ...
                        <el-row :gutter="10">
                          <div class="postInfo-container">
                            ...
                            <el-form-item id="operationdescription" label="Description">
                              <el-col :span="24">
                                <el-input v-model="operationform.opdesc" @keyup.enter="getOperations" />
                              </el-col>
                            </el-form-item>
                            <el-form-item id="operationpartitem" label="Item">
                              <el-col :span="12">
                                <el-input v-model="operationform.itemNumber" class="filter-item search-condition-1" placeholder="Item" style="font-size:1rem;" clearable @keyup.enter="getOperations">
                                  <template #prepend>
        ...
        <el-row :gutter="10">
          <el-col ref="leftcol" :xs="24" :sm="24" :md="12">
            <div class="mixin-components-container">
              <el-row>
                <el-card class="box-card">
                  <template #header>
                        ...
                        <template #default="{row}">
                          ...
                          <template v-else>
                            <el-input
                              ...
                              class="edit-input"
                              size="default"
                              @keyup.enter="updateRoutingDetails(row)"
                              @keyup.esc="row.edit=!row.edit"
                            />
                          </template>
                        </template>
                      </el-table-column>
          ...
          <el-col ref="midcol" :xs="24" :sm="24" :md="1">
            <div class="mixin-components-container" :style="arrowObject">
              <div id="deleteroutingdetails" @click="deleteRoutingDetails"><el-icon class="ihover" style="font-size: 30px; cursor: pointer; margin: 10px;"><CaretRight /></el-icon></div>
              <div id="createroutingdetails" @click="createRoutingDetails"><el-icon class="ihover" style="font-size: 30px; cursor: pointer; margin: 10px;"><CaretLeft /></el-icon></div>
              <div id="deleteallroutingdetails" @click="deleteAllRoutingDetails"><el-icon class="ihover" style="font-size: 30px; cursor: pointer; margin: 10px;"><DArrowRight /></el-icon></div>
            </div>
          </el-col>

          <el-col ref="rightcol" :xs="24" :sm="24" :md="11">
            <div class="mixin-components-container">
              <el-row>
                <el-card class="box-card">
                  <template #header>
...
export default {
  ...
  methods: {
    ...
    componentHeightChange() {
      const height = [
        this.$refs.leftcol.$el.scrollHeight,
        this.$refs.midcol.$el.scrollHeight,
        this.$refs.rightcol.$el.scrollHeight
      ]
