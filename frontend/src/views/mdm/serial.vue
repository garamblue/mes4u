  ...
  <el-row>
    <el-col>
      <div class="components-container">
              ...
              <div>
                  ...
                  <el-form :inline="true" :model="listQuery">
                    <el-row style="margin-bottom:20px;">
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input id="ruledescription" v-model="listQuery.desc" class="filter-item" placeholder="Rule Description" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                      <el-col :sm="24" :md="24" :lg="4" style="padding-right:10px;">
                        <el-input id="rulemonthtype" v-model="listQuery.monthtype" class="filter-item" placeholder="Prefix Month Type" style="font-size:1rem;" clearable @keyup.enter="handleFilter" />
                      </el-col>
                      <!-- Button -->
                ...
                >
                  ...
                  <el-table-column label="Actions" align="left" class-name="small-padding fixed-width" min-width="180">
                    <template #default="{row}">
                      <Btn name="item" icon="Suitcase" @click="getItemList(row)" />
        ...
        <!-- Item List Modal -->
        <el-dialog v-model="dialogListVisible" title="Item List">
          <el-table
            v-loading="listLoading"
            :data="listItemData"
            border
          ...
          <pagination
            ...
            v-model:page="listItemQuery.page"
            v-model:limit="listItemQuery.limit"
            ...
            <el-row>
              ...
              <el-col :lg="12" :md="12">
                <el-form-item label="Start Number" prop="startNumber">
                  <el-input-number v-model="itemSet.startNumber" size="default" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-col :lg="12" :md="12">
                <el-form-item label="Encoding" prop="encoding">
                  <el-input-number v-model="itemSet.encoding" size="default" />
                </el-form-item>
              </el-col>
              <el-col :lg="12" :md="12">
                <el-form-item label="Digit" prop="digits">
                  <el-input-number v-model="itemSet.digits" size="default" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
