<template>
  <div class="components-container">
    ...
    <el-card class="box-card">
      <el-form label-width="30%" class="form-container" @submit.prevent="checkEnter">
        <el-row>
          <el-col :lg="10">
            <el-form-item id="searchitemtext" label="Item Number">
              <el-input v-model="itemNumber" placeholder="Item Number" autofocus @change="setItem" @keyup.enter="findItems" />
            </el-form-item>
          </el-col>
          <el-col :lg="14">
    ...
    <el-dialog v-model="dialogFormVisible" :title="textMap[dialogStatus]">
      <el-form ref="dataForm" :rules="rules" :model="itemSet" label-position="right" label-width="140px" style="margin-left:20px;margin-right:20px;" @submit.prevent="checkEnter">
        <el-row>
          <el-col :lg="20" :md="20">
          ...
          <el-col :lg="20" :md="20">
            <el-form-item label="Serial Rule Name" prop="serialruledescription">
              <SerialRuleList
                ...
                required
                @set-serial-rule="setSerialRule"
              />
              <!-- <el-input v-model="itemSet.serialruledescription"/> -->
            </el-form-item>
          </el-col>
          <el-col :lg="4" :md="4">
            <el-form-item label-width="0" prop="serialruleid">
        ...
        <el-row>
          <el-col :lg="11" :md="11">
            <el-form-item label="End Number" prop="endnumber">
              <el-input-number v-model="itemSet.endnumber" size="default" />
            </el-form-item>
          </el-col>
          <el-col :lg="11" :md="11">
        ...
        <el-row>
          <el-col :lg="11" :md="11">
            <el-form-item label="Net Weight" prop="netweight">
              <el-input-number v-model="itemSet.netweight" size="default" />
            </el-form-item>
          </el-col>
          <el-col :lg="11" :md="11">
            <el-form-item label="Gross Weight" prop="grossweight">
              <el-input-number v-model="itemSet.grossweight" size="default" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
      ...
      <el-form label-width="30%" class="form-container" @submit.prevent="checkEnter">
        ...
        <el-row>
          ...
          <el-col id="copyfrompacking" :lg="5" :md="10">
            <el-form label-position="right" label-width="100px" @submit.prevent="checkEnter">
              <el-form-item label="Copy from">
                <ItemList v-model="copypackingItem" placeholder=" " required @set-item="setCopyfromPacking" />
              </el-form-item>
            </el-form>
          </el-col>
          <el-col :lg="2" :md="2">
    ...
    <el-dialog v-model="pdialogFormVisible" :title="textMap[dialogStatus]">
      <el-row>
        <el-col :lg="24">
      ...
      <el-form ref="pdataForm" :rules="packingrules" :model="packingSet" label-position="right" label-width="170px" style="margin-left:20px;margin-right:20px;" @submit.prevent="checkEnter">
        ...
        <el-form-item label="Quantity" prop="packingqty">
          <el-input-number v-model="packingSet.packingqty" size="default" required />
        </el-form-item>
      ...
      <el-form label-width="30%" class="form-container" @submit.prevent="checkEnter">
        ...
        <el-row>
          ...
          <el-col id="copyfromlabel" :lg="5" :md="10">
            <el-form label-position="right" label-width="100px" @submit.prevent="checkEnter">
              <el-form-item label="Copy from">
                <ItemList v-model="copylabelItem" required @set-item="setCopyfromLabel" />
              </el-form-item>
            </el-form>
          </el-col>
          <el-col :lg="2" :md="2">
    ...
    <el-dialog v-model="ldialogFormVisible" :title="textMap[dialogStatus]">
      <el-form ref="ldataForm" :rules="labelrules" :model="labelSet" label-position="right" label-width="170px" style="margin-left:20px;margin-right:20px;" @submit.prevent="checkEnter">
...
// Long fields of the server model: empty is allowed, otherwise digits only
const validateInteger = message => (rule, value, callback) => {
  if (value === '' || value === null || value === undefined || /^\d+$/.test(String(value).trim())) {
    callback()
  } else {
  ...
  data() {
    return {
      ...
      listQuery: { // Search variable
        pagesize: 1,
        currentpage: 1, // 1-based: the server does currentpage - 1
        totalpage: 0,
        total: 0,
        prop: 'id',
        sort: 0,
    ...
    async findItems() {
      ...
      if (res.items.content.length > 0) {
        this.itemTable.map(v => {
          v.creationdateformat = this.to_date(v.creationdate)
          v.lastupdatedateformat = this.to_date(v.lastupdatedate)
        })
