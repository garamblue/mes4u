                    ...
                    <div class="filter-container clearfix">
                      <el-row>
                        <el-col :xs="24" :sm="24" :md="24">
                          ...
                          <el-input id="linename" v-model="listQuery.name" placeholder="Name" style="width: 200px;" class="filter-item" @keyup.enter="handleFilter" />
                          <el-input id="linealias" v-model="listQuery.alias" placeholder="Alias" style="width: 200px;" class="filter-item" @keyup.enter="handleFilter" />
...
export default {
  ...
  methods: {
    async getList() {
      ...
      this.list.map(v => {
        v.creationdateformat = this.to_date(v.creation_date)
      })
    },
    handleFilter() {
