<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      <el-button type="primary" round size="small" style="vertical-align: text-bottom;" @click="guide" @click.prevent.stop="guide">{{ route_name }} Guide</el-button>
      <template v-if="device!=='mobile'">
        <div id="user-status" class="right-menu-item hover-effect">{{ name }} 접속 중</div>
        <screenfull id="screenfull" class="right-menu-item hover-effect" />
      </template>

      <el-dropdown id="activity" class="avatar-container" trigger="click">
